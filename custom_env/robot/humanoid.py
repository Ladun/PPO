...
class Humanoid(WalkerBase, MJCFBasedRobot):
    ...
    def __init__(self, random_yaw=False, random_lean=False):
        WalkerBase.__init__(self, power=0.41, foot_list=["right_foot", "left_foot"])
        MJCFBasedRobot.__init__(self, get_model_data('humanoid_symmetric.xml'), 'torso', action_dim=17, obs_dim=44, self_collision=True)
    ...
    def robot_specific_reset(self, bullet_client):
        ...
        if self.random_yaw:
            ...
            self.robot_body.reset_orientation(bullet_client.getQuaternionFromEuler(orientation))
        self.initial_z = 0.8
