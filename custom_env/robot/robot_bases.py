...
class XmlBasedRobot():
    def __init__(self, robot_name, action_dim, obs_dim, self_collision):
        ...
        self.action_space = gymnasium.spaces.Box(-high, high)
        high = np.inf * np.ones([obs_dim])
        self.observation_space = gymnasium.spaces.Box(-high, high)
...
class MJCFBasedRobot(XmlBasedRobot):
    def __init__(self, model_xml, robot_name, action_dim, obs_dim, self_collision=True):
        super().__init__(robot_name, action_dim, obs_dim, self_collision)
